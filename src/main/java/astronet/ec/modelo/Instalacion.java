...
public class Instalacion implements Serializable{
	...
	public String toString() {
		return "Instalacion [id=" + id + ", tipoServicio=" + tipoServicio + ", nombre=" + nombre + ", direccion="
				+ direccion + ", telefono=" + telefono + ", coordenadas=" + coordenadas + ", observaciones="
				+ observaciones + ", tecnico=" + tecnico + "]";
	}
